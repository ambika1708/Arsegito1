...
//        fn_getlocation();
    ...
    private void fn_getlocation() {
        ...
        if (!isGPSEnable && !isNetworkEnable) {
            ...
            if (isNetworkEnable) {
                location = null;
                if (checkSelfPermission(ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && checkSelfPermission(Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
